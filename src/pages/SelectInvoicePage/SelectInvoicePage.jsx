...
import './select-invoice-page.scss'; // Import the new SCSS file
...
const SelectInvoicePage = () => {
    ...
    const handleRowClick = (inv_hash) => {
        history.push(`/render_invoice/${inv_hash}`);
    };

    return (
        <div className="select-invoice-page">
            ...
            <table className="invoice-table">
                ...
                <tbody>
                    {invoices.map(invoice => (
                        <tr key={invoice.inv_hash} onClick={() => handleRowClick(invoice.inv_hash)} className="clickable-row">
