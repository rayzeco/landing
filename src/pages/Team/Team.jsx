...
export default function ScaleTransformPage() {
      ...
      <section className="hero-section">
        <div className="container">
          <div className="hero-content">
            ...
            <br/><br/>
            <h1 className="tagline">Putting AI to work for the world</h1><br/>
            <h1 className="tagline">A decade of focus on impact<br/> <span style={{color: "var(--theme-color)"}}>AI WITH A HUMAN HISTORY</span></h1><br/>
            ...
            <div className="key-metrics">
              <div className="metric">
                ...
                <span className="metric-label">Years of AI Focus</span>
              </div>
              <div className="metric">
                <span className="metric-number">Hundreds</span>
                <span className="metric-label">Organizations Served</span>
              </div>
              <div className="metric">
                <span className="metric-number">Global</span>
                <span className="metric-label">Impact Across Economy</span>
              </div>
            </div>
          </div>
        </div>
