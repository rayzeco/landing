...
export default function PrivacyPolicy() {
  return (
    <Document>
      ...
      <p>
      During its business operations, Rayze acquires personal data, including information related to specific client services. This data is obtained when individuals register for jobs, create user profiles, participte inn public user posting areas like bulletin boards, discussion forums, and surveys. The gathered personal data may include details provided by users, such as names, mailing addresses, email addresses, phone numbers, and background information necessary for job applications.
